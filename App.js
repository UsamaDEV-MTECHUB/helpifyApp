...
function SearchTab() {
  return (
    <Tab.Navigator
          ...
          tabBarIcon: ({color, focused}) =>
            focused ? (
              <View style={styles.selectedView}>
                <Icon name="home" size={hp('2%')} color={color} />
                <Text style={{...styles.tabText, color: color}}>Home</Text>
              </View>
            ) : (
              <Icon name="home-outline" size={hp('3%')} color={color} />
            ),
          title: '',
        }}
      />
      <Tab.Screen
        ...
        options={{
          tabBarIcon: ({color, focused}) =>
            focused ? (
              <View style={styles.selectedView}>
                <Icon name="person" size={hp('2%')} color={color} />
                <Text style={{...styles.tabText, color: color}}>Profile</Text>
              </View>
            ) : (
              <Icon name="person-outline" size={hp('3%')} color={color} />
            ),
          title: '',
        }}
      />
      <Tab.Screen
        name="Ad"
        component={AdStackScreen}
        options={{
          tabBarIcon: ({color, focused}) =>
            focused ? (
              <View style={styles.selectedView}>
                <Icon name="add-circle" size={hp('3%')} color={color} />
      ...
      <Tab.Screen
        ...
        options={{
          tabBarIcon: ({color, focused}) =>
            focused ? (
              <View style={styles.selectedViewRight}>
                <Icon name="mail" size={hp('2%')} color={color} />
                <Text style={{...styles.tabText, color: color}}>Chat</Text>
              </View>
            ) : (
              <Icon name="mail-outline" size={hp('3%')} color={color} />
            ),
          title: '',
        }}
      />
...
function AdStackScreen() {
  return (
    <AdStack.Navigator>
      ...
      />
      <AdStack.Screen
        name="AddDetailInputScreen"
        component={AddDetailInputScreen}
        options={{headerShown: false}}
      />
      <AdStack.Screen
        name="Delivery"
...
function ProfileStackScreen() {
  return (
    <ProfileStack.Navigator>
      ...
      />
      <ProfileStack.Screen
        name="BTermsAndConditions"
        component={BTermsAndCondition}
        options={{headerShown: false}}
      />
      <ProfileStack.Screen
        name="CreateAd"
